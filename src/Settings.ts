export default {
	...
	dark: {
		folderExpanded: "FolderOpen_16x_inverse.svg",
		folder: "Folder_16x_inverse.svg",
		rootFolder: "SpecialFolder_16x_inverse.svg",
		rootFolderExpanded: "SpecialFolderOpen_16x_inverse.svg",
		file: "Document_16x_inverse.svg",
		colors: {
			background: "C5C5C5",
			foreground: "252526",
			outline: "252526",
	...
	light: {
		folderExpanded: "FolderOpen_16x.svg",
		folder: "Folder_16x.svg",
		rootFolder: "SpecialFolder_16x.svg",
		rootFolderExpanded: "SpecialFolderOpen_16x.svg",
		file: "Document_16x.svg",
		colors: {
			background: "656565",
			foreground: "F3F3F3"
		}
	...
	contrast: {
		folderExpanded: "FolderOpen_16x_contrast.svg",
		folder: "Folder_16x_contrast.svg",
		rootFolder: "SpecialFolder_16x_contrast.svg",
		rootFolderExpanded: "SpecialFolderOpen_16x_contrast.svg",
		file: "Document_16x_contrast.svg",
		colors: {
			background: "FFFFFF",
			foreground: "000000",
			outline: "000000"
	...
	iconDefinitions: [
		...
		{
			iconPath: "FolderOpen_16x.svg",
			fileExtensions: [],
			fileNames: []
		},
		{
			iconPath: "Folder_16x.svg",
			fileExtensions: [],
			fileNames: []
		},
		{
			iconPath: "Font_16x.svg",
			fileExtensions: [
				"woff",
				"woff2",
				"ttf",
